...
def _row4(e1s, e2sp, e3sp, e4sp, ed=None, d3s_v=_d3s, d3p_v=_d3p):
    ...
    if ed is not None:
        shells.insert(5, (2, ed, _dd))  # 3d before 4sp
    return shells

_STO3G.update({
    19: _row4(np.array([771.510368, 140.531577, 38.033329]),
              np.array([52.402040, 12.177107, 3.960373]),
              np.array([3.651584, 1.018783, 0.398745]),
              np.array([0.503982, 0.186001, 0.082140])),
    20: _row4(np.array([854.032495, 155.563085, 42.101442]),
              np.array([59.560299, 13.840533, 4.501371]),
              np.array([4.374706, 1.220532, 0.477708]),
              np.array([0.455849, 0.168237, 0.074295])),
    21: _row4(np.array([941.662425, 171.524986, 46.421355]),
              np.array([67.176688, 15.610418, 5.076992]),
              np.array([4.698159, 1.433088, 0.552930]),
              np.array([0.630933, 0.232854, 0.102831]),
              np.array([0.551700, 0.168286, 0.064930]), _d3s2, _d3p2),
    22: _row4(np.array([1033.57125, 188.26629, 50.95221]),
              np.array([75.25120, 17.48676, 5.68724]),
              np.array([5.39554, 1.64581, 0.63500]),
              np.array([0.71226, 0.26287, 0.11609]),
              np.array([1.64598, 0.50208, 0.19372]), _d3s2, _d3p2),
    23: _row4(np.array([1130.76252, 205.96980, 55.74347]),
              np.array([83.78385, 19.46956, 6.33211]),
              np.array([6.14115, 1.87325, 0.72276]),
              np.array([0.71226, 0.26287, 0.11609]),
              np.array([2.96482, 0.90436, 0.34893]), _d3s2, _d3p2),
    24: _row4(np.array([1232.32045, 224.46871, 60.74999]),
              np.array([92.77462, 21.55883, 7.01160]),
              np.array([6.89949, 2.10456, 0.81201]),
              np.array([0.75478, 0.27856, 0.12302]),
              np.array([4.24148, 1.29379, 0.49918]), _d3s2, _d3p2),
    25: _row4(np.array([1337.15327, 243.56414, 65.91796]),
              np.array([102.02200, 23.70772, 7.71049]),
              np.array([7.70196, 2.34934, 0.90645]),
              np.array([0.67098, 0.24763, 0.10936]),
              np.array([5.42695, 1.65539, 0.63870]), _d3s2, _d3p2),
    26: _row4(np.array([1447.40041, 263.64579, 71.35284]),
              np.array([111.91949, 26.00768, 8.45851]),
              np.array([8.54857, 2.60759, 1.00609]),
              np.array([0.59212, 0.21853, 0.09650]),
              np.array([6.41180, 1.95580, 0.75461]), _d3s2, _d3p2),
    27: _row4(np.array([1560.83467, 284.30798, 76.94484]),
              np.array([122.27510, 28.41410, 9.24115]),
              np.array([9.43931, 2.87929, 1.11092]),
              np.array([0.59212, 0.21853, 0.09650]),
              np.array([7.66453, 2.33793, 0.90204]), _d3s2, _d3p2),
    28: _row4(np.array([1679.77103, 305.97239, 82.80807]),
              np.array([132.85889, 30.87355, 10.04104]),
              np.array([10.33074, 3.15121, 1.21583]),
              np.array([0.63093, 0.23285, 0.10283]),
              np.array([8.62772, 2.63173, 1.01540]), _d3s2, _d3p2),
    29: _row4(np.array([1801.80673, 328.20135, 88.82409]),
              np.array([144.12122, 33.49067, 10.89221]),
              np.array([11.30775, 3.44923, 1.33082]),
              np.array([0.63093, 0.23285, 0.10283]),
              np.array([9.64791, 2.94292, 1.13547]), _d3s2, _d3p2),
    30: _row4(np.array([1929.43230, 351.44850, 95.11568]),
              np.array([155.84168, 36.21425, 11.77800]),
              np.array([12.28153, 3.74626, 1.44542]),
              np.array([0.88971, 0.32836, 0.14501]),
              np.array([10.94737, 3.33930, 1.28840]), _d3s2, _d3p2),
    31: _row4(np.array([2061.42453, 375.49105, 101.62253]),
              np.array([167.76187, 38.98425, 12.67889]),
              np.array([12.61506, 3.84799, 1.48468]),
              np.array([0.79852, 0.29471, 0.13015]),
              np.array([12.61506, 3.84799, 1.48468]), _d3s2, _d3p2),
    32: _row4(np.array([2196.38423, 400.07413, 108.27567]),
              np.array([180.38904, 41.91853, 13.63321]),
              np.array([14.19666, 4.33043, 1.67082]),
              np.array([0.98583, 0.36383, 0.16067]),
              np.array([14.19666, 4.33043, 1.67082]), _d3s2, _d3p2),
    33: _row4(np.array([2337.06567, 425.69943, 115.21088]),
              np.array([193.19705, 44.89484, 14.60120]),
              np.array([15.87164, 4.84135, 1.86795]),
              np.array([1.10768, 0.40880, 0.18053]),
              np.array([15.87164, 4.84135, 1.86795]), _d3s2, _d3p2),
    34: _row4(np.array([2480.62681, 451.84927, 122.28805]),
              np.array([206.15788, 47.90666, 15.58073]),
              np.array([17.63999, 5.38076, 2.07606]),
              np.array([1.21464, 0.44828, 0.19797]),
              np.array([17.63999, 5.38076, 2.07606]), _d3s2, _d3p2),
    35: _row4(np.array([2629.99747, 479.05732, 129.65161]),
              np.array([219.83503, 51.08493, 16.61441]),
              np.array([19.50173, 5.94865, 2.29517]),
              np.array([1.39604, 0.51523, 0.22753]),
              np.array([19.50173, 5.94865, 2.29517]), _d3s2, _d3p2),
    36: _row4(np.array([2782.16006, 506.77393, 137.15280]),
              np.array([233.95141, 54.36528, 17.68128]),
              np.array([21.45685, 6.54502, 2.52527]),
              np.array([1.59005, 0.58683, 0.25915]),
              np.array([21.45685, 6.54502, 2.52527]), _d3s2, _d3p2),
})

_BASIS_SETS = {'sto-3g': _STO3G, '6-31g': _631G}
_ATOMIC_NUMBER = {
...
def _active_space_integrals(C: np.ndarray, H_core: np.ndarray, eri: np.ndarray,
    ...
    n_occ = n_electrons // 2
    n_frozen = n_occ - act_el // 2
    active_start = n_frozen
    active_end = n_frozen + act_orb
    ...
    h1_act = h1_mo[active_start:active_end, active_start:active_end].copy()
    for i in range(act_orb):
        for j in range(act_orb):
            ii, jj = i + active_start, j + active_start
            for k in range(n_frozen):
                h1_act[i, j] += 2.0 * eri_mo[ii, jj, k, k] - eri_mo[ii, k, k, jj]

    h2_act = eri_mo[active_start:active_end, active_start:active_end,
                    active_start:active_end, active_start:active_end].copy()
