...
import numpy as np
from tinyqubit.qml.kernel import kernel_matrix
from tinyqubit.qml.layers import zz_feature_map, amplitude_feature_map
...
K_train = kernel_matrix(zz_feature_map, X_train)
K_test = kernel_matrix(zz_feature_map, X_test, X_train)
...
amp_map = lambda q, x: amplitude_feature_map(q, x, decompose=True)
K_train2 = kernel_matrix(amp_map, X_train, qubits=[0, 1])
K_test2 = kernel_matrix(amp_map, X_test, X_train, qubits=[0, 1])
